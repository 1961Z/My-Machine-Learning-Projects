...
J = (1/m) * sum(sum((-y_vector.*log(last_layer)) - ((1 - y_vector).* log(1-last_layer))));
...
for t=1:m
  ...
  delta_a3 = a_3 - yVector; 

  delta_a2 = (Theta2)' * delta_a3 .* [1; sigmoidGradient(z_2)]; 
  delta_a2 = delta_a2(2:end); 
  
  Theta2_grad += delta_a3 * a_2';
  Theta1_grad += delta_a2 * a_1';
endfor
